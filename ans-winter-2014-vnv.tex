...
program consistent with [the NQA-1 standard]'' \cite{add}. To facilitate its use, PyNE seeks to
...
Through the use of version control, unit testing, pull requests, and
...
demanded by the standard. Additional documentation of these practices for
