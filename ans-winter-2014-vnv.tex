...
individually, as opposed to the with the waterfall model, where the review 
...
less than required for waterfall strategies.  Agile mechanisms allow for developer
...
common practice among software projects is to update all supported \texttt{develop}
...
in the user's and developer's guides. Pull requests constitute \emph{software design
...
documentation are version controlled with Git which fully supports these
