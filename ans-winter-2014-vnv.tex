...
PyNE is a
trans-institutional, open source project consisting of a collection of
...
specification, design, implementation, verification, and maintenance.  Each of
these stages is conceived of as flowing into the next stage.  Each stage must be 
