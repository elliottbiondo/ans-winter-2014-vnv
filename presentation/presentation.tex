...
\item{PyNE developers are a diverse bunch}:
   \begin{itemize}
   \item{Experience: Undergraduates through tenured proffesors}
...
\begin{itemize}
\item{Assign a unique identifier to a version of a codebase (e.g. a snapshot of 
...
\begin{column}{0.5\textwidth}
    ...
    \visible<4->{\item{Record or the pull request is perminatly saved -- almost 300 requests so far}}
    \end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
