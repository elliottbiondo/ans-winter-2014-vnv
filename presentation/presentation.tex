...
\only<1-2>{\centerline{\includegraphics[width=\textwidth]{figures/CI_wait.png}}}
\only<2>{A remote job is launched...}
\only<3>{\centerline{\includegraphics[width=\textwidth]{figures/CI_pass.png}}}
\only<4>{\centerline{\includegraphics[width=\textwidth]{figures/CI_fail.png}}}
